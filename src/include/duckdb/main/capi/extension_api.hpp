...
inline duckdb_ext_api_v1 CreateAPIv1() {
    duckdb_ext_api_v1 result;
        ...
        result.duckdb_create_storage_extension = duckdb_create_storage_extension;
        result.duckdb_destroy_storage_extension = duckdb_destroy_storage_extension;
        result.duckdb_storage_extension_set_extra_info = duckdb_storage_extension_set_extra_info;
        result.duckdb_storage_extension_get_extra_info = duckdb_storage_extension_get_extra_info;
        result.duckdb_storage_extension_set_attach = duckdb_storage_extension_set_attach;
        result.duckdb_storage_extension_set_transaction = duckdb_storage_extension_set_transaction;
        result.duckdb_config_add_storage_extension = duckdb_config_add_storage_extension;
        result.duckdb_attach_info_get_name = duckdb_attach_info_get_name;
        result.duckdb_attach_info_get_path = duckdb_attach_info_get_path;
        result.duckdb_attach_info_set_path = duckdb_attach_info_set_path;
        result.duckdb_attach_info_set_duck_catalog = duckdb_attach_info_set_duck_catalog;
        result.duckdb_attach_info_set_error = duckdb_attach_info_set_error;
        result.duckdb_attach_info_get_extra_info = duckdb_attach_info_get_extra_info;
        result.duckdb_attach_info_get_client_context = duckdb_attach_info_get_client_context;
        result.duckdb_attach_info_get_option_varchar = duckdb_attach_info_get_option_varchar;
        result.duckdb_attach_info_get_option_boolean = duckdb_attach_info_get_option_boolean;
        result.duckdb_attach_info_get_option_bigint = duckdb_attach_info_get_option_bigint;
        result.duckdb_attach_info_get_option_double = duckdb_attach_info_get_option_double;
        result.duckdb_transaction_info_set_duck_transaction_manager = duckdb_transaction_info_set_duck_transaction_manager;
        result.duckdb_transaction_info_set_error = duckdb_transaction_info_set_error;
        result.duckdb_transaction_info_get_extra_info = duckdb_transaction_info_get_extra_info;
