...
typedef struct {
    ...
    void (*duckdb_storage_extension_set_extra_info)(duckdb_storage_extension extension,void * extra_info,duckdb_delete_callback_t destroy);
    ...
    void (*duckdb_storage_extension_set_transaction)(duckdb_storage_extension extension,duckdb_storage_create_transaction_t create_transaction);
    duckdb_state (*duckdb_config_add_storage_extension)(duckdb_config config,const char * type,duckdb_storage_extension extension);
...
#define duckdb_create_storage_extension duckdb_ext_api.duckdb_create_storage_extension
#define duckdb_destroy_storage_extension duckdb_ext_api.duckdb_destroy_storage_extension
#define duckdb_storage_extension_set_extra_info duckdb_ext_api.duckdb_storage_extension_set_extra_info
#define duckdb_storage_extension_get_extra_info duckdb_ext_api.duckdb_storage_extension_get_extra_info
#define duckdb_storage_extension_set_attach duckdb_ext_api.duckdb_storage_extension_set_attach
#define duckdb_storage_extension_set_transaction duckdb_ext_api.duckdb_storage_extension_set_transaction
#define duckdb_config_add_storage_extension duckdb_ext_api.duckdb_config_add_storage_extension
#define duckdb_attach_info_get_name duckdb_ext_api.duckdb_attach_info_get_name
#define duckdb_attach_info_get_path duckdb_ext_api.duckdb_attach_info_get_path
#define duckdb_attach_info_set_path duckdb_ext_api.duckdb_attach_info_set_path
#define duckdb_attach_info_set_duck_catalog duckdb_ext_api.duckdb_attach_info_set_duck_catalog
#define duckdb_attach_info_set_error duckdb_ext_api.duckdb_attach_info_set_error
#define duckdb_attach_info_get_extra_info duckdb_ext_api.duckdb_attach_info_get_extra_info
#define duckdb_attach_info_get_client_context duckdb_ext_api.duckdb_attach_info_get_client_context
#define duckdb_attach_info_get_option_varchar duckdb_ext_api.duckdb_attach_info_get_option_varchar
#define duckdb_attach_info_get_option_boolean duckdb_ext_api.duckdb_attach_info_get_option_boolean
#define duckdb_attach_info_get_option_bigint duckdb_ext_api.duckdb_attach_info_get_option_bigint
#define duckdb_attach_info_get_option_double duckdb_ext_api.duckdb_attach_info_get_option_double
#define duckdb_transaction_info_set_duck_transaction_manager duckdb_ext_api.duckdb_transaction_info_set_duck_transaction_manager
#define duckdb_transaction_info_set_error duckdb_ext_api.duckdb_transaction_info_set_error
#define duckdb_transaction_info_get_extra_info duckdb_ext_api.duckdb_transaction_info_get_extra_info
